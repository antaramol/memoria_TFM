...
\titulodirector{Profesora Contratado Doctor}
...
\portadaPFC{figuras/LogoUS.pdf}{figuras/logoDINEL.png} %logo de la Universidad y logo del departamento, si lo hubiera. Para cambiar el pie de página con los logos, debe editarse el fichero ediciónPFC.sty
...
\include{cap1/cap1}%Introducción
%
\include{cap2/cap2}%Creación del modelo
% 
\include{cap3/cap3}%Despliegue del modelo
%

\include{conlcusiones/conclusiones}
% 
